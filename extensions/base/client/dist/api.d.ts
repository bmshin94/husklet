...
export interface ExecutionSummary {
    ...
    result?: {
        ...
        value: {
            status: number;
            detail: number;
            reason: 'unknown' | 'fetch' | 'memory' | 'decode' | 'unsupported' | 'frozen' | 'cache_epoch' | 'protocol' | 'native_fatal';
        };
    } | null;
...
export declare class TerminalCommandStartProtocolError extends Error {
    readonly expected: Readonly<Pick<PaneText, 'slot' | 'generation' | 'revision'> & {
...
export interface WorkspaceApi {
    ...
    extensions: {
        ...
        startAcquisition(reference: string, options?: {
            refresh?: boolean;
    ...
    containers: {
        ...
        processPages(id: string, options?: {
            limit?: number;
            signal?: AbortSignal;
         ...
         */
        resumeExecutionFailureStreaming(failure: ExecutionOperationError, options: {
            pageLimit?: number;
            maxPages?: number;
            pollIntervalMs?: number;
            signal?: AbortSignal;
        }, onPage: (page: ExecutionOutputPage) => void | Promise<void>): ReturnType<WorkspaceApi['containers']['resumeExecutionStreaming']>;
        ...
        execLines(id: string, generation: number, options: {
            command: string[];
            environment?: [string, string][];
            /** Credential keys resolved by the host directly into process environment variables. */
            credentials?: [environment: string, key: string][];
        ...
        }, onLine: (text: string, line: number) => void | Promise<void>): Promise<{
            executionId: string;
            execution: ExecutionSummary;
            lines: number;
        }>;
         ...
         */
        execJsonLinePages<Value = unknown>(id: string, generation: number, options: {
            command: string[];
            environment?: [string, string][];
            credentials?: [environment: string, key: string][];
            user?: string;
    ...
    terminal: {
        ...
        pinTabAndWait(tab: string, pinned?: boolean, options?: {
            timeoutMs?: number;
        }): Promise<{
            changed: true;
            tab: TabSummary;
        ...
        commandWait(command: TerminalCommand, options?: {
            timeoutMs?: number;
        }): Promise<TerminalCommand>;
        commandCancel(command: TerminalCommand, options?: {
            signal?: string;
            timeoutMs?: number;
        }): Promise<TerminalCommand>;
        ...
        recoverSemanticAction(recovery: SemanticActionOperationError | SemanticActionRecoveryToken): Promise<{
            committed: true;
            operation: string;
            slot: string;
        }>;
    ...
    files: {
        ...
        resumeText(failure: FileTextOperationError, options?: {
            signal?: AbortSignal;
        }): Promise<FileText>;
    ...
    postgres: {
        ...
        recoverCancel(recovery: PostgresCancelOperationError | PostgresCancelRecoveryToken): Promise<PostgresCancelRecoveryToken & {
            state: PostgresQueryState;
        }>;
        closeQuery(lease: PostgresLeaseId, query: PostgresQueryId): Promise<void>;
        closeQueryOnce(operation: QueryOperationToken, lease: PostgresLeaseId, query: PostgresQueryId): Promise<void>;
        ...
        closeQueryRecoverable(lease: PostgresLeaseId, query: PostgresQueryId, options?: {
            operation?: QueryOperationToken;
        }): Promise<PostgresCloseRecoveryToken>;
        closeLeaseRecoverable(lease: PostgresLeaseId, options?: {
            operation?: QueryOperationToken;
        }): Promise<PostgresCloseRecoveryToken>;
        recoverClose(recovery: PostgresCloseOperationError | PostgresCloseRecoveryToken): Promise<PostgresCloseRecoveryToken & {
            closed: true;
        }>;
    };
