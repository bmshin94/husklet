    ...
    let _ = writeln!(
        ...
        "button {{ background: transparent; color: {text}; border: 1px solid transparent; border-radius: {radius}px; min-height: 28px; min-width: 28px; padding: 3px 10px; font-size: 13px; font-weight: 500; box-shadow: none; transition: 120ms ease; }}\n\
         ...
         paned.hl-responsive-divider.horizontal > separator, paned.hl-splitter.horizontal > separator {{ min-width: 2px; min-height: 28px; \
           background: {line}; border-left: 3px solid transparent; border-right: 3px solid transparent; background-clip: padding-box; }}\n\
         paned.hl-responsive-divider.vertical > separator, paned.hl-splitter.vertical > separator {{ min-height: 2px; min-width: 28px; \
           background: {line}; border-top: 3px solid transparent; border-bottom: 3px solid transparent; background-clip: padding-box; }}\n\
         paned.hl-responsive-divider.horizontal > separator:hover, paned.hl-responsive-divider.horizontal > separator:focus, paned.hl-responsive-divider.horizontal:focus > separator, paned.hl-splitter.horizontal > separator:hover, .keyboard-focus.horizontal > separator {{ \
           background-color: {accent}; border-left-color: transparent; border-right-color: transparent; }}\n\
         paned.hl-responsive-divider.vertical > separator:hover, paned.hl-responsive-divider.vertical > separator:focus, paned.hl-responsive-divider.vertical:focus > separator, paned.hl-splitter.vertical > separator:hover, .keyboard-focus.vertical > separator {{ \
         ...
         .hl-splitter-handle {{ background: {line}; }}\n\
         .hl-splitter-handle.keyboard-highlight, .hl-splitter-handle.pointer-highlight {{ background-color: {accent}; }}\n\
         .hl-splitter.splitter-horizontal > separator {{ min-width: 2px; min-height: 28px; background: {line}; border-left: 3px solid transparent; border-right: 3px solid transparent; background-clip: padding-box; }}\n\
         .hl-splitter.splitter-vertical > separator {{ min-height: 2px; min-width: 28px; background: {line}; border-top: 3px solid transparent; border-bottom: 3px solid transparent; background-clip: padding-box; }}\n\
...
fn standard_buttons(css: &mut String, theme: &Theme) {
    ...
    let _ = writeln!(
        ...
        "button.hl-button, button.hl-button:hover, button.hl-button:active {{ background: transparent; border: 0; outline: none; box-shadow: none; }}\n\
         ...
         button.hl-button.variant-outline:hover > .hl-button-chrome, button.hl-button.variant-ghost:hover > .hl-button-chrome, button.hl-button.variant-outline > .hl-button-chrome.hl-hover-proof, button.hl-button.variant-ghost > .hl-button-chrome.hl-hover-proof {{ background: {raised}; color: {text}; border-color: {line}; }}\n\
         button.hl-button.variant-filled:hover > .hl-button-chrome, button.hl-button.variant-filled > .hl-button-chrome.hl-hover-proof {{ box-shadow: inset 0 0 0 999px rgba(255,255,255,.10); }}\n\
         button.hl-button.variant-outline:active > .hl-button-chrome, button.hl-button.variant-ghost:active > .hl-button-chrome, button.hl-button.variant-outline > .hl-button-chrome.hl-active-proof, button.hl-button.variant-ghost > .hl-button-chrome.hl-active-proof {{ background: {surface}; color: {text}; border-color: {dim}; box-shadow: inset 0 1px 2px rgba(0,0,0,.24); }}\n\
         button.hl-button.variant-filled:active > .hl-button-chrome, button.hl-button.variant-filled > .hl-button-chrome.hl-active-proof {{ box-shadow: inset 0 0 0 999px rgba(0,0,0,.14); }}\n\
...
fn inline_buttons(css: &mut String, theme: &Theme) {
    let _ = writeln!(
        ...
        "button.hl-inline-button, button.hl-inline-button:hover, button.hl-inline-button:active {{ background: transparent; border: 0; outline: none; box-shadow: none; }}\n\
         ...
         button.hl-inline-button.variant-outline:focus > .hl-inline-button-chrome, button.hl-inline-button.variant-outline:focus-visible > .hl-inline-button-chrome, button.hl-inline-button.variant-outline > .hl-inline-button-chrome.hl-focus-visible-proof {{ border: 2px solid {accent}; box-shadow: none; outline: none; }}\n\
...
mod tests {
    ...
    fn inline_buttons_separate_hit_target_from_visual_chrome() {
        ...
        assert!(css.contains(
            "button.hl-inline-button.variant-outline:focus > .hl-inline-button-chrome, button.hl-inline-button.variant-outline:focus-visible > .hl-inline-button-chrome, button.hl-inline-button.variant-outline > .hl-inline-button-chrome.hl-focus-visible-proof { border: 2px solid #559df7; box-shadow: none; outline: none; }"
        ));
    }
    ...
    fn dividers_have_visible_eight_pixel_targets_and_two_pixel_handles() {
        ...
        assert!(css.contains(
            "background: #323843; border-left: 3px solid transparent; border-right: 3px solid transparent; background-clip: padding-box;"
        ));
        ...
        assert!(css.contains(".hl-splitter-handle { background: #323843;"));
        assert!(css.contains("paned.hl-responsive-divider.horizontal:focus > separator"));
        assert!(
            !css.contains("paned.hl-responsive-divider.horizontal:focus-within > separator"),
            "focus inside navigation must not make its adjacent resize handle look active"
        );
        assert!(css.contains(
