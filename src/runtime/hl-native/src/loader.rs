...
pub(crate) struct TestApi {
    ...
    pub(crate) x86_64_double_shift_memory_ea: NoArgumentTest,
    pub(crate) x86_64_bus_guard_cost: ScenarioTest,
...
impl TestApi {
    fn load(library: &DynamicLibrary, path: &Path) -> Result<Self, LoadError> {
        ...
        Ok(Self {
            ...
            native_supervised_hostname_projection: symbol!(
                "hl_native_supervised_hostname_projection_test",
                ScenarioTest
            ),
            ...
            x86_64_double_shift_memory_ea: symbol!("hl_x86_64_double_shift_memory_ea_test", NoArgumentTest),
            x86_64_bus_guard_cost: symbol!("hl_x86_64_bus_guard_cost_test", ScenarioTest),
