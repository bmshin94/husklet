...
#[doc(hidden)]
pub fn native_checkpoint_admission_test(proc_root: &std::ffi::CStr, pid: i32, private_fds: &[i32]) -> i32 {
    bindings::native_checkpoint_admission_test(proc_root, pid, private_fds)
}
