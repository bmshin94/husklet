...
static const hl_option_definition hl_option_definitions[] = {
    ...
    HL_LAUNCH_OPTION("HL_TRANSLIT_DIRECT_CALL_PRE_SPILL",
                     "enable the same-ISA direct-CALL pre-spill fast path", HL_OPTION_FLAG),
    ...
    HL_LAUNCH_OPTION("HL_X86_EA_RECORD_ELIDE",
    ...
    HL_LAUNCH_OPTION("HL_CALL_SIM_DIAG_ONLY",
                     "maintain the call-simulation shadow table only while diagnostics can read it", HL_OPTION_FLAG),
    HL_LAUNCH_OPTION("HL_EXEC_IBTC_LAZY", "leave the indirect-branch cache lazily cleared across guest exec",
                     HL_OPTION_FLAG),
    HL_LAUNCH_OPTION("HL_EXEC_CENSUS_LAZY",
    ...
    HL_LAUNCH_OPTION("HL_NATIVE_SUPERVISED", "run a Linux x86-64 guest natively under syscall supervision",
                     HL_OPTION_FLAG),
    HL_LAUNCH_OPTION("HL_NATIVE_SUPERVISED_PANE",
                     "widen the supervised terminal ioctl surface and project a devpts for pty-spawning guests",
                     HL_OPTION_FLAG),
    HL_LAUNCH_OPTION("HL_NATIVE_CKPT_CARRY_ALTSTACK",
    ...
    HL_LAUNCH_OPTION("HL_TRANSLIT", "select the same-ISA transliterating backend for an x86-64 guest", HL_OPTION_FLAG),
    ...
    HL_LAUNCH_OPTION("HL_PCACHE_LIBS", "persist translations of content-keyed guest library mappings",
                     HL_OPTION_FLAG),
    HL_LAUNCH_OPTION("HL_PCACHE_LINK_IMAGE",
                     "treat a non-PIE image at its deterministic link address as cache-revivable",
                     HL_OPTION_FLAG),
    HL_LAUNCH_OPTION("HL_PCACHE_CONVERGE", "let a warm run re-publish the cache within bounded growth",
                     HL_OPTION_FLAG),
    HL_INTERNAL_OPTION("HL_PCACHE_OBSERVE", "emit structured persistent-cache diagnostics", HL_OPTION_FLAG),
    HL_INTERNAL_OPTION("HL_XLAT_CENSUS", "append a cross-process translation-provenance census to a path",
                       HL_OPTION_PATH),
    ...
    HL_LAUNCH_OPTION("HL_TRANSLIT_FS_LOAD_BRIDGE",
                     ...
                     HL_OPTION_FLAG),
    HL_LAUNCH_OPTION("HL_TRANSLIT_RIPREL_LOAD_BRIDGE",
